...
export default function Hero() {
    return (
        <section className="relative">
            ...
            <div className="px-5 text-center py-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:space-y-5">
                ...
                <div className="hidden md:block md:text-white md:text-xl max-w-md">
                    <h1>Dream Wall Print is ready to transform your walls into works of art. Let us create unforgettable interiors for you!</h1>
                </div>
            </div>
        </section>
    )
