...
export default function Footer() {
  return (
    <Container section width="md:max-w-4xl"
      ...
      <div className="space-y-4">
        <div>
          ...
          <a href="tel:+447459073560" className="hover:underline underline-offset-4 hover:text-orange">+44 7459
            073560</a>
        </div>
        <div>
          <p className="text-xs">Email</p>
          <a href="mailto:contact@dreamwallprint.com"
             className="hover:underline underline-offset-4 hover:text-orange">contact@dreamwallprint.com</a>
        </div>
